...
class AppConfig(BaseSettings):
    ...
    web_search_query_limit: int = Field(default=12, alias="WEB_SEARCH_QUERY_LIMIT")
    web_search_query_workers: int = Field(default=4, alias="WEB_SEARCH_QUERY_WORKERS")
    web_page_fetch_workers: int = Field(default=6, alias="WEB_PAGE_FETCH_WORKERS")
